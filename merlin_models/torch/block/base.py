...
class SequentialBlock(BlockBase, torch.nn.Sequential):
    def __init__(self, *args, output_size=None):
        # from merlin_models.torch import TabularSequenceFeatures, TransformerBlock
        #
    ...
    @property
    def inputs(self):
        from merlin_models.torch import TabularFeatures
    ...
    def as_tabular(self, name=None):
        from merlin_models.torch import AsTabular
